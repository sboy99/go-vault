...
// PrometheusRecorder implements domain.MetricsRecorder.
type PrometheusRecorder struct{}

var _ domain.MetricsRecorder = (*PrometheusRecorder)(nil)

func NewPrometheusRecorder() *PrometheusRecorder {
	return &PrometheusRecorder{}
}

func (PrometheusRecorder) BackupSucceeded(started time.Time, size int64) {
...
func (PrometheusRecorder) BackupFailed() {
	BackupFailuresTotal.Inc()
}

func (PrometheusRecorder) RestoreFinished(status string) {
	RestoreTotal.WithLabelValues(status).Inc()
}

func (PrometheusRecorder) BackupPruned() {
	RetentionPrunedTotal.Inc()
}
