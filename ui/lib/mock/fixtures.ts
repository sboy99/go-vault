...
const mockBackups: Backup[] = [
  {
    ...
    name: "1726966800_app_backup.sql.gz",
    storage_key: "1726966800_app_backup.sql.gz",
  ...
  },
  {
    ...
    name: "1726880400_app_backup.sql.gz",
    storage_key: "1726880400_app_backup.sql.gz",
    database_type: "POSTGRESQL",
    storage_type: "LOCAL",
    status: "success",
  ...
  },
  {
    ...
    name: "1726794000_app_backup.sql.gz",
    storage_key: "1726794000_app_backup.sql.gz",
    database_type: "POSTGRESQL",
    storage_type: "LOCAL",
    status: "failed",
  ...
  },
  {
    ...
    name: "1726707600_app_backup.sql.gz",
    storage_key: "1726707600_app_backup.sql.gz",
    database_type: "POSTGRESQL",
    storage_type: "LOCAL",
    status: "success",
...
const mockConfig: RedactedConfig = {
  app: { name: "go-vault", version: "0.3.0" },
  db: {
    type: "POSTGRESQL",
    host: "db.internal",
    port: 5432,
